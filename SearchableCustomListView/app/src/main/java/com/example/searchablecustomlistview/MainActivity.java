package com.example.searchablecustomlistview;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myCustomListView.setOnItemClickListener(this);
    ...
    private ArrayList<Customer> populateCustomerData(ArrayList<Customer> customers) {
        ...
        customers.add(new Customer("Asin", "Kaif", 9, R.mipmap.ic_launcher));
        customers.add(new Customer("Arshi", "Khan", 10, R.mipmap.ic_launcher));
